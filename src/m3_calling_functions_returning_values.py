...
def run_test_digits_in_power():
    ...
    #   Include at least **   3   ** tests.
    #
    # Use the same 4-step process as in implementing the previous TEST
    # functions.
    # ------------------------------------------------------------------
    print()
    print('--------------------------------------------------')
...
def digits_in_power(n, k):
    ...
    return sum_of_digits(powered_digit)
